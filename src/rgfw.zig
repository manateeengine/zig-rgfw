...
extern "c" fn RGFW_alloc(size: usize) callconv(.c) *anyopaque;
extern "c" fn RGFW_copyImageData(dest_data: *u8, w: i32, h: i32, dest_format: RgfwFormat, src_data: *u8, src_format: RgfwFormat) callconv(.c) void;
extern "c" fn RGFW_createSurface(data: *u8, w: i32, h: i32, format: RgfwFormat) callconv(.c) *RgfwSurface;
extern "c" fn RGFW_createSurfacePtr(data: *u8, w: i32, h: i32, format: RgfwFormat, surface: *RgfwSurface) callconv(.c) bool;
extern "c" fn RGFW_createWindow(name: [*c]const u8, x: i32, y: i32, w: i32, h: i32, flags: u32) callconv(.c) *RgfwWindow;
extern "c" fn RGFW_createWindowPtr(name: [*c]const u8, x: i32, y: i32, w: i32, h: i32, flags: u32, win: *RgfwWindow) callconv(.c) *RgfwWindow;
extern "c" fn RGFW_free(ptr: *anyopaque) callconv(.c) void;
extern "c" fn RGFW_freeMouse(mouse: *RgfwMouse) callconv(.c) void;
extern "c" fn RGFW_getDisplay_Wayland() callconv(.c) *anyopaque;
extern "c" fn RGFW_getDisplay_X11() callconv(.c) *anyopaque;
extern "c" fn RGFW_getLayer_OSX() callconv(.c) *anyopaque;
extern "c" fn RGFW_getMonitors(len: *usize) callconv(.c) *[]RgfwMonitor;
extern "c" fn RGFW_getPrimaryMonitor() callconv(.c) RgfwMonitor;
extern "c" fn RGFW_loadMouse(data: *u8, w: i32, h: i32, format: RgfwFormat) callconv(.c) *RgfwMouse;
extern "c" fn RGFW_monitorModeCompare(mon: RgfwMonitor, mon2: RgfwMonitor, request: RgfwModeRequest) callconv(.c) bool;
extern "c" fn RGFW_monitor_scaleToWindow(mon: RgfwMonitor, win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_monitor_requestMode(mon: RgfwMonitor, mon2: RgfwMonitor, request: RgfwModeRequest) callconv(.c) bool;
extern "c" fn RGFW_pollEvents() callconv(.c) void;
extern "c" fn RGFW_moveToMacOSResourceDir() callconv(.c) void;
extern "c" fn RGFW_setClassName(name: [*c]const u8) callconv(.c) void;
extern "c" fn RGFW_setQueueEvents(queue: bool) callconv(.c) void;
extern "c" fn RGFW_setXInstName(name: [*c]const u8) callconv(.c) void;
extern "c" fn RGFW_sizeofNativeImage() callconv(.c) usize;
extern "c" fn RGFW_sizeofSurface() callconv(.c) usize;
extern "c" fn RGFW_sizeofWindow() callconv(.c) usize;
extern "c" fn RGFW_sizeofWindowSrc() callconv(.c) usize;
extern "c" fn RGFW_stopCheckEvents() callconv(.c) void;
extern "c" fn RGFW_surface_free(surface: *RgfwSurface) callconv(.c) void;
extern "c" fn RGFW_surface_freePtr(surface: *RgfwSurface) callconv(.c) void;
extern "c" fn RGFW_surface_getNativeImage(surface: *RgfwSurface) callconv(.c) *RgfwNativeImage;
extern "c" fn RGFW_useWayland(wayland: bool) callconv(.c) void;
extern "c" fn RGFW_usingWayland() callconv(.c) bool;
extern "c" fn RGFW_waitForEvent(wait_ms: i32) callconv(.c) void;
extern "c" fn RGFW_window_blitSurface(win: *RgfwWindow, surface: *RgfwSurface) callconv(.c) void;
extern "c" fn RGFW_window_createSurface(win: *RgfwWindow, data: *u8, w: i32, h: i32, format: RgfwFormat) callconv(.c) *RgfwSurface;
extern "c" fn RGFW_window_createSurfacePtr(win: *RgfwWindow, data: *u8, w: i32, h: i32, format: RgfwFormat, surface: *RgfwSurface) callconv(.c) bool;
extern "c" fn RGFW_window_getEnabledEvents(win: *RgfwWindow) callconv(.c) u32;
extern "c" fn RGFW_window_getExitKey(win: *RgfwWindow) callconv(.c) RgfwKey;
extern "c" fn RGFW_window_getFlags(win: *RgfwWindow) callconv(.c) u32;
extern "c" fn RGFW_window_getHDC(win: *RgfwWindow) callconv(.c) ?*anyopaque;
extern "c" fn RGFW_window_getHWND(win: *RgfwWindow) callconv(.c) ?*anyopaque;
extern "c" fn RGFW_window_getPosition(win: *RgfwWindow, x: *i32, y: *i32) callconv(.c) bool;
extern "c" fn RGFW_window_getSize(win: *RgfwWindow, x: *i32, y: *i32) callconv(.c) bool;
extern "c" fn RGFW_window_getSrc(win: *RgfwWindow) callconv(.c) *RgfwWindowSrc;
extern "c" fn RGFW_window_getUserPtr(win: *RgfwWindow) callconv(.c) *anyopaque;
extern "c" fn RGFW_window_getView_OSX(win: *RgfwWindow) callconv(.c) ?*anyopaque;
extern "c" fn RGFW_window_getWindow_OSX(win: *RgfwWindow) callconv(.c) ?*anyopaque;
extern "c" fn RGFW_window_getWindow_Wayland(win: *RgfwWindow) callconv(.c) ?*anyopaque;
extern "c" fn RGFW_window_getWindow_X11(win: *RgfwWindow) callconv(.c) ?u64;
extern "c" fn RGFW_window_setDisabledEvents(win: *RgfwWindow, events: u32) callconv(.c) void;
extern "c" fn RGFW_window_setEnabledEvents(win: *RgfwWindow, events: u32) callconv(.c) void;
extern "c" fn RGFW_window_setEventState(win: *RgfwWindow, event: u32, state: bool) callconv(.c) void;
extern "c" fn RGFW_window_setExitKey(win: *RgfwWindow, key: RgfwKey) callconv(.c) void;
extern "c" fn RGFW_window_setLayerOsx(win: *RgfwWindow, layer: *anyopaque) callconv(.c) void;
extern "c" fn RGFW_window_setUserPtr(win: *RgfwWindow, ptr: *anyopaque) callconv(.c) void;
