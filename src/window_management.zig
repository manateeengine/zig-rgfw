...
extern "c" fn RGFW_getGlobalMouse(x: *i32, y: *i32) callconv(.c) bool;
extern "c" fn RGFW_window_allowsDND(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_borderless(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_center(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_checkEvent(win: *RgfwWindow, event: *RgfwEvent) callconv(.c) bool;
extern "c" fn RGFW_window_checkQueuedEvent(win: *RgfwWindow, event: *RgfwEvent) callconv(.c) bool;
extern "c" fn RGFW_window_close(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_closePtr(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_didDataDrop(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_didMouseEnter(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_didMouseLeave(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_focus(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_getDataDrag(win: *RgfwWindow, x: *i32, y: *i32) callconv(.c) bool;
extern "c" fn RGFW_window_getDataDrop(win: *RgfwWindow, files: *[][*:0]const u8, count: *usize) callconv(.c) bool;
extern "c" fn RGFW_window_getMouse(win: *RgfwWindow, x: *i32, y: *i32) callconv(.c) bool;
extern "c" fn RGFW_window_hide(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_holdMouse(win: *RgfwWindow, area: RgfwArea) callconv(.c) void;
extern "c" fn RGFW_window_isDataDragging(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isFloating(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isFullscreen(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isHidden(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isHoldingMouse(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isInFocus(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isKeyDown(win: *RgfwWindow, key: RgfwKey) callconv(.c) bool;
extern "c" fn RGFW_window_isKeyPressed(win: *RgfwWindow, key: RgfwKey) callconv(.c) bool;
extern "c" fn RGFW_window_isKeyReleased(win: *RgfwWindow, key: RgfwKey) callconv(.c) bool;
extern "c" fn RGFW_window_isMaximized(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isMinimized(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isMouseDown(win: *RgfwWindow, button: RgfwMouseButton) callconv(.c) bool;
extern "c" fn RGFW_window_isMouseHidden(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isMouseInside(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_isMousePressed(win: *RgfwWindow, button: RgfwMouseButton) callconv(.c) bool;
extern "c" fn RGFW_window_isMouseReleased(win: *RgfwWindow, button: RgfwMouseButton) callconv(.c) bool;
extern "c" fn RGFW_window_maximize(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_minimize(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_move(win: *RgfwWindow, v: RgfwPoint) callconv(.c) void;
extern "c" fn RGFW_window_moveMouse(win: *RgfwWindow, v: RgfwPoint) callconv(.c) void;
extern "c" fn RGFW_window_moveToMonitor(win: *RgfwWindow, m: RgfwMonitor) callconv(.c) void;
extern "c" fn RGFW_window_raise(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_resize(win: *RgfwWindow, a: RgfwArea) callconv(.c) void;
extern "c" fn RGFW_window_restore(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_setAspectRatio(win: *RgfwWindow, a: RgfwArea) callconv(.c) void;
extern "c" fn RGFW_window_setBorder(win: *RgfwWindow, border: bool) callconv(.c) void;
extern "c" fn RGFW_window_setDND(win: *RgfwWindow, allow: bool) callconv(.c) void;
extern "c" fn RGFW_window_setFlags(win: *RgfwWindow, flags: u32) callconv(.c) void;
extern "c" fn RGFW_window_setFloating(win: *RgfwWindow, floating: bool) callconv(.c) void;
extern "c" fn RGFW_window_setFullscreen(win: *RgfwWindow, fullscreen: bool) callconv(.c) void;
extern "c" fn RGFW_window_setIcon(win: *RgfwWindow, data: *u8, w: i32, h: i32, format: RgfwFormat) callconv(.c) bool;
extern "c" fn RGFW_window_setIconEx(win: *RgfwWindow, data: *u8, w: i32, h: i32, format: RgfwFormat, icon_type: RgfwIcon) callconv(.c) void;
extern "c" fn RGFW_window_setMaxSize(win: *RgfwWindow, a: RgfwArea) callconv(.c) void;
extern "c" fn RGFW_window_setMinSize(win: *RgfwWindow, a: RgfwArea) callconv(.c) void;
extern "c" fn RGFW_window_setMouse(win: *RgfwWindow, mouse: *RgfwMouse) callconv(.c) void;
extern "c" fn RGFW_window_setMouseDefault(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_setMousePassthrough(win: *RgfwWindow, passthrough: bool) callconv(.c) void;
extern "c" fn RGFW_window_setMouseStandard(win: *RgfwWindow, mouse: RgfwMouseIcons) callconv(.c) void;
extern "c" fn RGFW_window_setName(win: *RgfwWindow, name: [*c]const u8) callconv(.c) void;
extern "c" fn RGFW_window_setOpacity(win: *RgfwWindow, opacity: u8) callconv(.c) void;
extern "c" fn RGFW_window_setShouldClose(win: *RgfwWindow, should_close: bool) void;
extern "c" fn RGFW_window_shouldClose(win: *RgfwWindow) callconv(.c) bool;
extern "c" fn RGFW_window_show(win: *RgfwWindow) callconv(.c) void;
extern "c" fn RGFW_window_showMouse(win: *RgfwWindow, show: bool) callconv(.c) void;
extern "c" fn RGFW_window_unholdMouse(win: *RgfwWindow) callconv(.c) void;
